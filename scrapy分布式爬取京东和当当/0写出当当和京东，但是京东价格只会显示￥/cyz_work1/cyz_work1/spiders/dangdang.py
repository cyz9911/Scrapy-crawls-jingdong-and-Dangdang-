...
#http://bang.dangdang.com/books/bestsellers/01.00.00.00.00.00-recent30-0-0-1-2
#http://bang.dangdang.com/books/bestsellers/01.00.00.00.00.00-recent30-0-0-1-24
...
class DangdangSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for li in li_list:
            ...
            # item['author'] = li.xpath('./div[@class="publisher_info"][1]/text()').extract()[1]
            try:
                #正常爬取
                item['author'] = li.xpath('./div[@class="publisher_info"][1]/text()').extract()[1]
            except IndexError:
            ...
            item['time'] = li.xpath('./div[@class="publisher_info"][2]/span/text()').extract()
            item['recommend'] = li.xpath('./div[@class="star"]/span[@class="tuijian"]/text()').extract()
